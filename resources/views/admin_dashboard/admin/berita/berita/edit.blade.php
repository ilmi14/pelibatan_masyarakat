    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
            <div class="widget-content-area br-4">
                ...
                @endif
                <form action="{{ route('berita.update', [$berita->id]) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        ...
                        <div class="d-flex justify-content-center">
                            @if ($berita->banner != null)
                                <img class="rounded img-fluid" src="{{ Storage::url($berita->banner) }}" alt="foto" id="preview" width="400px" height="300px">
                            @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="n-chk">
                            <label class="new-control new-radio radio-primary">
                                <input type="radio" class="new-control-input" name="publish" value="Ya" {{ old('publish', $berita->publish) == 'Ya'? 'checked' : '' }} required>
                                <span class="new-control-indicator"></span>Ya
                            </label>
                            <label class="new-control new-radio radio-primary">
                                <input type="radio" class="new-control-input" name="publish" value="Tidak" {{ old('publish', $berita->publish) == 'Tidak'? 'checked' : '' }} required>
