    ...
    <div class="widget-content widget-content-area mb-3">
        ...
        <div class="widget-content">
            ...
            <div id="editPost" style="display:none">
                <form action="{{ route('peserta.kelasku.forum.update', [$kelas->id, $post->id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method("put")
                    ...
                    <div id="comment{{ $comment->id }}">
                        ...
                        <div class="mt-2">
                            ...
                            <div id="editComment{{ $comment->id }}" style="display:none">
                                <form action="{{ route('peserta.kelasku.forum.comment.update', [$kelas->id, $post->id, $comment->id]) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method("put")
                ...
                <div class="bg-light p-2" id="comment">
                    ...
                    <form action="{{ route('peserta.kelasku.forum.comment.store', [$kelas->id, $post->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-2 text-right">
                            ...
                            <a href="{{ route('peserta.kelasku.forum.index', $kelas->id) }}" class="btn btn-sm btn-dark-light ml-1 shadow-none">Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
