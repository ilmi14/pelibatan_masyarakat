...
@section('content')
    ...
    <div class="widget-content widget-content-area">
        ...
        @forelse ($posts as $post)
            <a href="{{ route('peserta.kelasku.forum.show', [$kelas->id, $post->id]) }}">
                <div class="card mb-3">
    ...
    <div class="modal fade" id="buatDiskusi" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form action="{{ route('peserta.kelasku.forum.store', $kelas->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @csrf
