                                            ...
                                            @if ($js->jawaban_id != null)
                                                <div class="row">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="col">
                                                            <a href="{{ route('tutor.kelasku.tugas.periksa-tugas.show', [$kelas->id, $tugas->id, $js->jawaban_id]) }}" class="btn btn-primary btn-round btn-sm"><i class="far fa-check-square"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            @else
