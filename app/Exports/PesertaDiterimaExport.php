...
class PesertaDiterimaExport implements FromCollection, WithMapping, WithHeadings, ShouldAutoSize, WithStyles
{
    /**
    ...
    */
    ...
    {
        return RegistrasiKelas::where('kelas_id', $this->kelas_id)->where('status', 'Diterima')->get();
    }
